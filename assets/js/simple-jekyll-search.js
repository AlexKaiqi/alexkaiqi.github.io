 ...
 */
SimpleJekyllSearch({
    searchInput: document.getElementById('search-input'), // REQUIRED: The input element on which the plugin should listen for keyboard event and trigger the searching and rendering for articles.
    ...
    fuzzy: false, // OPTIONAL. Enable fuzzy search to allow less restrictive matching.
    exclude: [] // OPTIONAL. Pass in a list of terms you want to exclude (terms will be matched against a regex, so urls, words are allowed).
});
